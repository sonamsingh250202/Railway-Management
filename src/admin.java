...
class admin
{
    ...
    void train_info()
    {
        ...
        else
        {
            ...
            train_db(num,name,seats,bp,dp,f[0],f[1],f[2],f[3],dtime,atime);
        }
    }
    ...
    void user_signup() throws Exception
    {
        ...
        Connection c=DriverManager.getConnection("jdbc:mysql://localhost:3306/railway?autoReconnect=true&useSSL=false","root","");
    ...
    void train_db(int tnum,String tname,int seats,String bp,String dp,int i,int j,int k,int l, String dtime,String atime)
    {
        ...
        try
        {
            Class.forName("com.mysql.jdbc.Driver");
            Connection c=DriverManager.getConnection("jdbc:mysql://localhost:3306/railway?autoReconnect=true&useSSL=false","root","");
            PreparedStatement st=c.prepareStatement("insert into train (tnum,tname,seats,bp,dp,fAC,sAC,tAC,sc,dtime,atime) values(?,?,?,?,?,?,?,?,?,?,?)");
            st.setInt(1,tnum);
            ...
            st.setInt(8,k);
            st.setInt(9,l);
            st.setString(10,dtime);
            st.setString(11,atime);
            st.executeUpdate();
        }
        catch(Exception e)
        {
    ...
    void setwR(int tnum, String str1, int seats,String str10,String str11, int fAc,int sAc,int tAc,int sc, String str7,String str9, int width)
    {
...
//            System.out.print(' ');
    ...
    void disp_train_db()
    {
        ...
        try
        {
            ...
            Connection c=DriverManager.getConnection("jdbc:mysql://localhost:3306/railway?autoReconnect=true&useSSL=false","root","");
            System.out.println("***************************************************************************************************************************************************************************************");
            System.out.println("Train Number   Train Name     Seats         source      Destination    First AC       Second AC      Third AC       Sleeper Coach     Departure      Arrival");
            System.out.println("***************************************************************************************************************************************************************************************");
            Statement st=c.createStatement();
            ResultSet r=st.executeQuery("select * from train");
            while(r.next())
            {
                setwR(r.getInt(1),r.getString(2),r.getInt(3),r.getString(4),r.getString(5),r.getInt(6),r.getInt(7),r.getInt(8),r.getInt(9), r.getString(11),r.getString(12),15);
            }
    ...
    void setwR(long pnr, String str1,int age,String str3, int seats,String str5,String str6,Timestamp tm, int width)
    {
    ...
    void disp_chart() throws Exception
    {
        try
        {
            ...
            Connection c=DriverManager.getConnection("jdbc:mysql://localhost:3306/railway?autoReconnect=true&useSSL=false","root","");
            System.out.println("***************************************************************************************************************************************************************************************");
            System.out.println("PNR Number          Name                Age                 Gender              Seat Number         Coach               Status              Booking time");
            System.out.println("***************************************************************************************************************************************************************************************");
            Statement st=c.createStatement();
            ResultSet r=st.executeQuery("select * from chart where pnr>0 and tnum='"+tn+"' ");
            while(r.next())
            {
                setwR(r.getLong(1),r.getString(2),r.getInt(3),r.getString(4),r.getInt(5),r.getString(6),r.getString(7),r.getTimestamp(8),20);
            }
        }
        catch(Exception e)
        {
